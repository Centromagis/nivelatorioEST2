...
#devtools::install_github("Centromagis/paqueteNIV") # Descarga paqueteDEG
...
**Figura 2.3** Evento B como la unión de intersecciones $A_{i} \cap B$
</center>
...
```{r}
titanic3 <- load("data/titanic3.rda")
...
* $P(\text{survived} = 0) = 0.618029$ : Probabilidad de no sobrevivir en un accidente similar
